...
public class Ass implements AssConstants {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Ass encodingParser = create(new InputStreamReader(new FileInputStream(args[0]), DEFAULT_ENCODING),
        ...
        Ass a = create(usedReader, new DebugXMLContentHandler(Charset.forName(encoding))); //new NullXMLContentHandler(encoding));//
        a.xmlDocument();
    }
